...
<head>
    ...
    <script type="text/javascript" src='https://staging.doku.com/doku-js/assets/js/doku.js'></script>
...
} else if ($paymentchannel=="01"){
$serverurl='./paymentDoku_MandiriClickpay.php';
} else {
...
<script src="http://staging.doku.com/doku-js/assets/js/doku.js?version=<?php echo time()?>"></script> <!-- To prevent js caching -->
